...
import com.shing.intelligentquiz.model.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<List<QuestionContentDTO>> aiGenerateQuestion(@RequestBody AiGenerateQuestionRequest aiGenerateQuestionRequest) {
        ...
        List<QuestionContentDTO> questionContentDTOList = questionService.generateQuestion(aiGenerateQuestionRequest);
    ...
    @ApiOperation(value = "AI 流式生成题目")
    public SseEmitter aiGenerateQuestionSSE(AiGenerateQuestionRequest aiGenerateQuestionRequest) {
        return questionService.generateQuestionsByFlowable(aiGenerateQuestionRequest);
    }
